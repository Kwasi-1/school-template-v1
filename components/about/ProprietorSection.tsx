        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-10 items-center ">
          ...
          <div className="lg:-ml-10 w-6/7">
            ...
            <p className="text-gray-600 mt-4">
              ...
              excellence and innovation. With years of experience in the
              education sector, he has been instrumental in shaping the school's
              mission and values. His passion for education continues to inspire
