        ...
        <div className="max-w-full xl:max-w-[85%] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {importantDates.map((item, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 border border-gray-100 hover:border-[#800020]/20 hover:shadow-md transition-all duration-300 group"
              >
                <div className="flex items-start gap-4">
                  {/* Calendar Icon */}
                  <div className="w-14 h-14 bg-[#800020]/10 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-[#800020] transition-colors duration-300">
                    <Icon
                  ...
                  {/* Content */}
                  <div>
                    <p className="text-[#737477] text-sm mb-1">{item.label}</p>
