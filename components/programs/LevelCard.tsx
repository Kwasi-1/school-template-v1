  ...
  return (
    ...
    >
      ...
      <div className={`${!isEven ? "lg:order-1" : ""}`}>
        ...
        <h3 className="text-2xl md:text-3xl lg:text-4xl font-normal mt-2 mb-4">
          {level.name}
        </h3>
        <p className="text-[#737477] leading-relaxed mb-6">
          {level.description}
        </p>
        ...
        <ul className="space-y-3 mb-8">
          {level.highlights.map((highlight, idx) => (
            <li key={idx} className="flex items-center gap-3">
              <div className="w-6 h-6 bg-[#800020]/10 rounded-full flex items-center justify-center flex-shrink-0">
                <Icon icon="mdi:check" className="w-3 h-3 text-[#800020]" />
              </div>
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {level.subjects.length > 5 && (
            <span className="px-3 py-1 bg-[#800020]/10 text-[#800020] text-sm rounded-full">
        ...
        <Link
          href="/admissions"
          className="inline-flex items-center gap-2 text-[#800020] font-medium hover:underline"
        >
