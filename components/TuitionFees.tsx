...
export default function TuitionFees() {
  return (
    <section className="relative py-16 px-6 md:px-20 flex flex-col md:flex-row gap-6">
      {/* Title Section */}
      <div className="max-w-3xl">
        ...
        <p className="text-gray-500 mt-4 text-lg">
          At Unipix University Name we are committed to providing a high-quality
      ...
      {/* Tuition Cards */}
        ...
        <div className="bg-[#800020] text-white rounded-xl p-6 md:w-1/2">
        ...
        {/* Graduate Programs */}
        <div className="bg-gray-100 text-black rounded-xl p-6 md:w-1/2">
